    ...
    public class LoginController : ControllerBase
    {
        ...
        public IActionResult Login(LoginViewModel dadosLogin)
        {
            try
            {
                ...
                {
                    return Unauthorized(new { msg = "E-mail e/ou Senha Incorreta" });
                }
                ...
                var meuToken = new JwtSecurityToken(issuer: "chapter.webapi", audience: "chapter.webapi", claims: minhaClaims, expires: DateTime.Now.AddMinutes(60), signingCredentials: credenciais);
