...
using encontro_remoto8.Interfaces;
...
namespace encontro_remoto8.Classes
{
    public class PessoaJuridica : Pessoa, IPessoaJuridica
    {
        ...
        public void Inserir(PessoaJuridica PJ)
        {
            ...
            string[] pjString = {$"{PJ.razaoSocial}, {PJ.cnpj}, {PJ.rendimento}"};
        ...
        public List<PessoaJuridica> ler()
        {
            ...
            foreach(var porLinha in linhas) {
            
            PessoaJuridica novaPJ = new PessoaJuridica();

            string[] atributos = porLinha.Split(", ");

            novaPJ.razaoSocial = atributos[0];
            novaPJ.cnpj = long.Parse(atributos[1]);
            novaPJ.rendimento = long.Parse(atributos[2]);
